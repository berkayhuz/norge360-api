...
{
    [Fact]
    public void Audit_interceptor_should_be_sealed()
    {
        Assert.True(typeof(Norge360.Persistence.EntityFrameworkCore.Auditing.AuditSaveChangesInterceptor).IsSealed);
    }
}