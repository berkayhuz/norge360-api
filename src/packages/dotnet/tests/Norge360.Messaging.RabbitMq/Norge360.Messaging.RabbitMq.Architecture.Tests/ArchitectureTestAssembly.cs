...
{
    internal static readonly Assembly ProductionAssembly = typeof(Norge360.Messaging.RabbitMq.DependencyInjection.RabbitMqServiceCollectionExtensions).Assembly;
}