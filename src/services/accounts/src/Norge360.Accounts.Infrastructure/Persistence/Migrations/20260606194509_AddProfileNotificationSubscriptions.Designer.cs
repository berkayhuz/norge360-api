...
namespace Norge360.Accounts.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260606194509_AddProfileNotificationSubscriptions")]
    partial class AddProfileNotificationSubscriptions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Norge360.Accounts.Domain.Entities.UserBlock", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("UserBlocks", null, t =>
                        {
                            t.HasCheckConstraint("CK_UserBlocks_BlockerProfileId_NotEqual_BlockedProfileId", "\"BlockerProfileId\" <> \"BlockedProfileId\"");
                        });
                });
