// <copyright file="NotificationTrustedGatewayOptionsValidation.cs" company="Norge360">
...
namespace Norge360.Notification.API.Security;

public sealed class NotificationTrustedGatewayOptionsValidation(IHostEnvironment environment) : IValidateOptions<TrustedGatewayOptions>
{
