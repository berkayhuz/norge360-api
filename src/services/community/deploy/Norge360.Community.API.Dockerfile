...
RUN dotnet restore services/community/src/Norge360.Community.API/Norge360.Community.API.csproj --force-evaluate
RUN dotnet publish services/community/src/Norge360.Community.API/Norge360.Community.API.csproj -c Release --no-restore -o /app/publish -p:UseAppHost=false
